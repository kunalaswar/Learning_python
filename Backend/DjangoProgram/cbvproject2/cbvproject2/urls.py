...
from testapp.views import BookListView,BookListView2,BookDetailView,BookCreateView,BookUpdateView,BookDeleteView
urlpatterns = [
    path('admin/', admin.site.urls),
    path('list/', BookListView.as_view()), 
    path('list2/', BookListView2.as_view(),name='listbooks'),
